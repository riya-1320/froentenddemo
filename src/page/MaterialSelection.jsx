...
import {BallTriangle, Oval, Puff} from 'react-loader-spinner'
...
const MaterialSelection = ({onExportPDF}) => {
  ...
  if (loading) return <div className="loader"><Puff
  visible={true}
  height="80"
  width="80"
  color="#FF1B47"
  ...
  return (
    <div className="container1">
       <button className="usqu-logout-button" onClick={()=> logout()}>
          logout
        </button>
      ...
      <div ref={quotationPDFRef} className="quotationpdf">
